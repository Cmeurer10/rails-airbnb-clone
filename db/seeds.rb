...
books << Book.new({"title"=>"calculus 1B", "edition"=>"4td", "condition"=>"Poor", "price"=>14, "subject"=>"Math 102", "description"=>"Quite heavily used before, but it is still solid and usable.", "publisher"=>"McGraw Hill", "isbn"=>"1123433356"})
books << Book.new({"title"=>"Calculus-1B", "edition"=>"4td", "condition"=>"Fair", "price"=>19, "subject"=>"Math 102", "description"=>"Some marks on the pages, in fair to good condition overall.", "publisher"=>"McGraw Hill", "isbn"=>"1123456456"})
books << Book.new({"title"=>"Calculus 1B", "edition"=>"4td", "condition"=>"Good", "price"=>24, "subject"=>"Math 102", "description"=>"Quite heavily used before, but it is still solid and usable.", "publisher"=>"McGraw Hill", "isbn"=>"1123456789"})
